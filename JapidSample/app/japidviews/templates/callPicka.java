...
"\n");// line 1
 List<String> strings = new ArrayList<String>(){{add("you");add("me");add("them");}};// line 10
		p("\n");// line 10
		_aTag0.setActionRunners(getActionRunners()).setOut(getOut()); _aTag0.render(strings);// line 12
		p("\n" + 
"note: the picka tag is defined in the japidviews/_tags directory\n" + 
"\n");// line 12
		_picka1.setActionRunners(getActionRunners()).setOut(getOut()); _picka1.render("a", "b" + "c", new picka.DoBody<String>(){
...
"    ");// line 17
		_SampleTag2.setActionRunners(getActionRunners()).setOut(getOut()); _SampleTag2.render(r);// line 19
...
"\n");// line 20
		_picka3.setActionRunners(getActionRunners()).setOut(getOut()); _picka3.render(named("a", "aa"), named("b", "bb"));// line 26
		p("\n" + 
"or \n");// line 26
		_picka4.setActionRunners(getActionRunners()).setOut(getOut()); _picka4.render("cc","dd");// line 29
		p("\n" + 
"</p>\n" + 
"<p>\n" + 
...
"</p>\n" + 
"\n");// line 29
		_japidviews_templates_aTag5.setActionRunners(getActionRunners()).setOut(getOut()); _japidviews_templates_aTag5.render(strings);// line 36
		p("\n" + 
"<p>You can use \".\" instead of \"/\" in the path:</p>\n" + 
"\n");// line 36
		_japidviews_templates_aTag6.setActionRunners(getActionRunners()).setOut(getOut()); _japidviews_templates_aTag6.render(strings);// line 40
		;// line 40
