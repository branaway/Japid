...
- templates are transformed to Java for best possible performance. This step takes place automatically in Play!'s DEV mode. Command line tools are provided for manual transformation.   
