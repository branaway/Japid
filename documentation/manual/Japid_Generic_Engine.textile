...
This is the base class for all Java classes derived from the Japid templates. The template classes has one method named @render(arg1, arg2...)@ that developers can use to invoke them and get a string result.
