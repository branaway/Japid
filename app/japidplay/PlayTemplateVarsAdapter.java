...
import bran.japid.FlashScope;
import bran.japid.UrlMapper;
import bran.play.FlashWrapper;
import bran.play.ParamsWrapper;
import bran.play.RouteAdapter;
...
public class PlayTemplateVarsAdapter {
	...
	private static UrlMapper urlMapper = new RouteAdapter();
