...
"\n" + 
"	    ");// line 16
		final Display _Display2 = new Display(getOut()); _Display2.setActionRunners(getActionRunners()).setOut(getOut()); _Display2.render( // line 18
new Display.DoBody<String>(){ // line 18
public void render(final String title) { // line 18
// line 18
		p("		   The real title is: ");// line 18
		p(title);// line 19
		p("\n" + 
"	    ");// line 19
...
, named("post", p), named("as", "home222"));// line 18
...
final Tag2 _Tag23 = new Tag2(getOut()); _Tag23.setActionRunners(getActionRunners()).setOut(getOut()); _Tag23.render(named("msg", blogTitle), named("age", 100)); // line 23// line 23
		p("\n" + 
"<p>cool cool!</p>");// line 23
